    ...
    return (
        ...
        <div class="square">
          <ul class="square-inner float">
            ...
            <li><Image width="100%" rounded src={require('../img/ss.jpeg')}/>2</li>
            <li><Image width="100%" rounded src={require('../img/ss.jpeg')}/>3</li>
            <li><Image width="100%" rounded src={require('../img/ss.jpeg')}/>4</li>
            <li><Image width="100%" rounded src={require('../img/ss.jpeg')}/>5</li>
            <li><Image width="100%" rounded src={require('../img/ss.jpeg')}/>6</li>
